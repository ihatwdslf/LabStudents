...
namespace grebeniuklab2.Strategy
{
    public static class Filter
    {
            ...
            string? specialization = null)
        {
            ...
            if (new[] { fullName, group, grade, discipline, teacher, specialization }.All(string.IsNullOrWhiteSpace))
            {
                return studentsList;
            }

            var filteredStudents = studentsList.Students.Where(student =>
                MatchesFilter(discipline, student.Discipline) &&
                MatchesFilter(teacher, student.Teacher) &&
